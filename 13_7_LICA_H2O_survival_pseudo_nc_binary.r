#           13.7. H2O DL Survival prediction model - LICA
...
setwd("C:/Users/Alex/OneDrive - alumni.unav.es/Master_Metodos_Computacionales_en_Ciencias/TFM/ClusteringJ_ANOVA/LICA_genetype")

# Data processing:
#########################################################
LICA_normalized_filtered_genetype <- read_excel("C:/Users/Alex/OneDrive - alumni.unav.es/Master_Metodos_Computacionales_en_Ciencias/TFM/ClusteringJ_ANOVA/LICA_genetype/LICA_normalized_filtered_genetype.xlsx")
...
survival <- read_excel("survival_binary.xlsx", na = "NA")
survival <- survival[,2]
...
mojo_destination <- h2o.save_mojo(modelo_final, path = getwd(),filename = "modelo_pseudo+nc_nfold20_survival")
